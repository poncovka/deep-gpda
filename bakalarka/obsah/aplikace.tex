...
\subsection{Formát zápisu automatu}\label{kap_aplikace_format}

Příklad formátování hlubokého zásobníkového automatu je k dispozici v ukázce \ref{example_format}. 
...
\subsection{Parsování automatu z~řetězce}
...
\subsection{Redukce nevstupních symbolů}
...
\subsection{Spuštění aplikace \texttt{gdeep\_pda}}
...
\texttt{--input=file}   	& Vstup se načte ze souboru file, jinak ze standardního vstupu. \\
