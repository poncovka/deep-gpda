...
$M_{NF} = ($ &$\{$ & $s_{\alpha}, s_{\beta},s_{\gamma} \ \}, $\\
     &$\{$ & $a,b,c,d,e \ \}, $\\
     ...
     && 1 :\quad$ s_{\beta}\ <q,A>\ \rightarrow\ s_{\beta}\ <q,A>'  ,$\\ 
     && 1 :\quad$ s_{\beta}\ <q,D>\ \rightarrow\ s_{\beta}\ <q,D>'   ,$\\ 
     && 1 :\quad$ s_{\beta}\ <p,\#>\ \rightarrow\ s_{\alpha}\ <q,\#>_{set}  ,$\\ 
     && 1 :\quad$ s_{\alpha}\ <2>\ \rightarrow\ s_{\gamma}\ <1>  ,$\\ 
     && 1 :\quad$ s_{\gamma}\ <q,A>'\ \rightarrow\ s_{\gamma}\ <q,A>  ,$\\ 
     && 1 :\quad$ s_{\gamma}\ <q,D>'\ \rightarrow \ s_{\gamma}\ <q,D>  ,$\\ 
     && 1 :\quad$ s_{\gamma}\ <q, \#>_{set}\ \rightarrow\ s_{\beta}\ <q, \#>  ,$\\ 
     && 1 :\quad$ s_{\beta}\ <r,A>\ \rightarrow\ s_{\beta}\ <r,A>'  ,$\\ 
     && 1 :\quad$ s_{\beta}\ <r,D>\ \rightarrow\ s_{\beta}\ <r,D>'  ,$\\ 
     && 1 :\quad$ s_{\beta}\ <r,\#>\ \rightarrow\ s_{\alpha}\ <r,\#>_{set}  ,$\\ 
     && 1 :\quad$ s_{\alpha}\ <1>\  \rightarrow\ s_{\alpha}\ \varepsilon  ,$\\ 
     && 1 :\quad$ s_{\alpha}\ <r,\#>_{set}\ \rightarrow\ s_{\gamma}\ <r, \#>_{exp}  ,$\\ 
     && 1 :\quad$ s_{\gamma}\ <r,A>'\ \rightarrow\ s_{\gamma}\ <r,A>  ,$\\ 
     && 1 :\quad$ s_{\gamma}\ <r,D>'\ \rightarrow\ s_{\gamma}\ <r,D>  ,$\\ 
     && 1 :\quad$ s_{\gamma}\ <r, \#>_{exp}\ \rightarrow\ s_{\alpha}\ <r, \#>  ,$\\ 
     &&$ \dots$ \\
     & $ \},$ \\
