...
\item Neterminály se postupně prochází z~leva do prava a pomocný stav se přepisuje stavem aktuálním. Po tomto kroku je simulace dokončena a celý postup se může opakovat.
\end{enumerate}
