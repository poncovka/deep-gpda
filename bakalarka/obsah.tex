...
\suspend{enumerate}
  ...
  \item Přidej do $R_{\Sigma}$ pravidla:
...
\renewcommand{\labelenumi}{(\roman{enumi})}
  ...
  \item $<q, 0^i>'' 0 \rightarrow <q, 0^{i+1}>'' \varepsilon $, kde $q \in Q$, $0 \le i \le n$,
  \item $<q, 0^i>'' 1 \rightarrow <q, 0^i 1>'' \varepsilon $, kde $q \in Q$, $0 \le i \le n$,
  \item $<q, \varphi(X) >'' \# \rightarrow <q, \varepsilon>'' X \# $, kde $X \in \Sigma$, $q \in Q$, $1 \le j \le n$,
  \item $<q, \varphi(X) >'' \# \rightarrow <q, \varepsilon>'' \varphi(X) \# $, kde $X \in (\Gamma - \Sigma)$, $q \in Q$, $1 \le j \le n$,
  \item $<q, 1 >' \# \rightarrow <q,\varepsilon> 1 \# $, kde $q \in Q$.
